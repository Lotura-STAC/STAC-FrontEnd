    ...
    <>
      ...
      <Wrapper>
        ...
        <HomeArticle
          ...
          subTitle={`현재 세탁기나 건조기가 사용 중인지를 온라인에서 확인할 수 있으므로, 집에 있지 않는 동안에도 기기의 작동 상태를 파악할 수 있습니다.
          모바일 애플리케이션의 경우 세탁이나 건조가 완료되었을 때 푸시 알림을 받을 수 있어서, 작업이 완료된 즉시 확인할 수 있습니다. 이로써 세탁물을 빠르게 처리하고 효율적으로 일상 생활을 관리할 수 있습니다.`}
          image={Home.HomeImg1}
          direction="ltr"
        />
        <HomeArticle
          ...
          또한 고객센터를 통해 수집된 피드백은 서비스나 제품 개선에 활용됩니다.`}
          image={Home.HomeImg2}
          direction="rtl"
        />
        {!isLoggedIn && (
